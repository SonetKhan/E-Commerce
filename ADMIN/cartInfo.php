...
<tr>
<td>SESSION ID</td>
<td><input type = "text" name = "SesId" value = "<?php print $row[0]?>" /></td>
</tr>
<tr>
<td>Product ID</td>
<td><input type = "text" name = "Pid" value = "<?php print $row[1] ?>" /></td>
</tr>

<tr>
<td>Quantity</td>
<td><input type = "text" name = "qunty" value = "<?php print $row[2] ?>" /></td>
</tr>
<tr>
<td>Price</td>
<td><input type = "text" name = "price" value = "<?php print $row[3] ?>" /></td>
</tr>
<tr>
<td>Entery Time</td>
<td><input type = "text" name = "time" value = "<?php print $row[4] ?>" /></td>
</tr>
<tr>
<td colspan = "2">
